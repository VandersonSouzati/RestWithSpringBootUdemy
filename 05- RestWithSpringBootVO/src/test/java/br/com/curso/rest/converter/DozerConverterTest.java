...
import br.com.curso.rest.converter.mocks.MockPerson;
...
public class DozerConverterTest {
	...
	public void parseEntityListToVOListTest() {
		List<PersonVO> outputList = DozerConverter.parseListsObjects(inputObject.mockEntityList(), PersonVO.class);
	...
	public void parserVOListToEntityListTest() {
		List<Person> outputList = DozerConverter
				.parseListsObjects(inputObject.mockVOList(), Person.class);
